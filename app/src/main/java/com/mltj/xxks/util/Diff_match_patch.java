...
//    }
    ...
    public static void main(String[] arge){
        ...
        String altbe = "llkkiij1";
        String altaf = "123【4】567【8】9";
        ...
        StringBuffer divstr=new StringBuffer("<div style=\"float:left;\">");
...
//                s1=divstr.append(s1).append("</div>").append(diffTextBe);
//                s2=divstr.append(s2).append("</div>").append(diffTextAf);
    ...
    public static Integer appendString2(String type, Diff diff, StringBuffer sbOne,
        ...
        if (type.equals(diff.operation.toString())) {
            ...
            ans.add(sb.toString());
            sbOne.append("<div style=\"color:#00FF00;float:left;\">").append(sb).append("</div>");
            result = i+sb.length();
        }
        return result;
    }
