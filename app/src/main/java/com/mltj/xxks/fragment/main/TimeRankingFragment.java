...
import com.mltj.xxks.adapter.RankingAdapter;
import com.mltj.xxks.bean.Ranking;
import com.mltj.xxks.bean.RankingResponse;
...
public class TimeRankingFragment extends BasiceFragment {
    ...
    protected void initView(View view) {
        ...
        rankingAdapter = new RankingAdapter(getActivity(), rankingArrayList);
    ...
    private void getData() {
        ...
        Call<String> call1 = apiService.getPaihang("");
        call1.enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                Gson gson = new Gson();
                try {
                    RankingResponse object = gson.fromJson(json, RankingResponse.class);
                    if (object != null) {
                        ArrayList<Ranking> list = object.getData();
                        if (list != null) {
