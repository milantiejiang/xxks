...
public class NoticeDetailActivity extends BasiceActivity implements View.OnClickListener {
    @BindView(R.id.back)
    ImageView back;
    ...
    protected void init() {
        ...
        notice = (Notice) getIntent().getSerializableExtra("object");
        if (notice != null) {
            title.setText(notice.getTitle());
            RichText.initCacheDir(this);
            tvContent = findViewById(R.id.tv_content);
            RichText.from(Util.getNoticeHtml(notice)).bind(this)
                    .showBorder(false)
    ...
    private void sendData(long duration) {
        ...
        Call<String> call1 = apiService.insertStudyRecord(42,1,duration/1000, notice.getId(),
